...
export async function login(__: Request, res: Response, next: NextFunction): Promise<void> {
    try {
 ...
 * マスタ管理ログアウト
 */
export async function logout(req: Request, res: Response, __: NextFunction): Promise<void> {
